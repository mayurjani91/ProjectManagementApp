...
export default function Dashboard() {
  ...
  const handleDragEnd = (result) => {
    ...
    const confirmDelete = window.confirm('Do you want this project into quick access?');
    ...
    if (confirmDelete) {
      ...
      const modifiedResult = {
        ...
        destination: {
          ...result.destination,
          droppableId: "quick-access", // Replace the droppableId with "quick-access"
        }
      };
   

    const { destination, draggableId } = modifiedResult;
    alert(JSON.stringify(destination.droppableId));
